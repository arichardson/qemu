...
static rv_opcode decode_cheri_rvy(rv_inst inst) {
    ...
    case 0:
        ...
        case 43:
            ...
            if (rd == 0) {
                if (rs1 == 0 && rs2 == 0) {
                    return rv_op_ymodeswy;
                }
                if (rs1 == 0 && rs2 == 1) {
                    return rv_op_ymodeswi;
                }
                return rv_op_illegal;
            }
            return rv_op_ymodew;
...
/* Decode the 9-bit YBNDSWI immediate as specified for SCBNDSI. */
static int32_t operand_ybndswi(rv_inst inst)
{
    ...
    if ((imm9 & 0xe0) == 0) {
        ...
        return 256 | ((imm9 & 0xf) << 4) | ((imm9 & 0x10) >> 1);
    }
    return (imm9 & 0xff) << 4;
}
